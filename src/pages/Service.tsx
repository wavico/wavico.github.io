  ...
  const services = [
    {
      ...
      description: "사용자 경험을 최우선으로 고려한 최신 기술 기반의 웹사이트와 모바일 앱을 개발합니다.",
      features: [
        "반응형 웹사이트 구축",
        "네이티브 및 하이브리드 앱 개발",
        "API 설계 및 개발",
    ...
    },
    {
      ...
      description: "음성, 이미지, 언어를 아우르는 인공지능 기술을 활용한 맞춤형 AI 솔루션을 제공합니다.",
      features: [
        "자연어 처리 (NLP) 기술",
        "이미지 인식 및 분석",
        "음성 인식 및 합성",
    ...
    },
    {
      ...
      description: "복잡한 데이터를 직관적으로 이해할 수 있는 대시보드와 시각화 솔루션을 제공합니다.",
      features: [
        "실시간 데이터 모니터링",
        "맞춤형 대시보드 설계",
        "다양한 차트 및 그래프 제공",
    ...
    },
    {
      ...
      description: "기존 시스템과 새로운 시스템을 효율적으로 통합하여 업무 효율을 극대화합니다.",
      features: [
        "ERP/CRM 시스템 통합",
        "레거시 시스템 마이그레이션",
        "클라우드 환경 구축 및 마이그레이션",
    ...
    },
    {
      ...
      description: "자연어 처리 기술을 활용한 지능형 챗봇으로 고객 서비스를 혁신합니다.",
      features: [
        "24/7 고객 지원",
        "자연어 이해 및 대화 기능",
        "다국어 지원",
      ...
      <section className="pt-40 pb-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <p className="text-xl max-w-2xl">
            Wavico는 음성·이미지·언어를 아우르는 인공지능 기술을 바탕으로 다양한 서비스를 제공합니다.
            여러분의 비즈니스에 필요한 맞춤형 솔루션을 찾아보세요.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="relative">
            ...
            {[
              { 
                title: "요구사항 분석", 
                description: "고객의 비즈니스 요구사항을 정확히 파악하고 분석합니다." 
              },
              { 
                title: "기획 및 설계", 
                description: "요구사항을 바탕으로 최적의 솔루션을 기획하고 설계합니다." 
              },
              { 
                title: "개발 및 구현", 
                description: "최신 기술과 방법론을 적용하여 솔루션을 개발합니다." 
              },
              { 
                title: "테스트 및 검증", 
                description: "품질 보증을 위한 철저한 테스트와 검증 과정을 거칩니다." 
              },
              { 
                title: "배포 및 운영", 
                description: "개발된 솔루션을 안정적으로 배포하고 운영 지원을 제공합니다." 
              },
            ].map((step, idx) => (
              <div
                key={idx}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Wavico와 함께 혁신적인 솔루션으로 비즈니스를 성장시키세요.
            전문가의 상담을 통해 최적의 서비스를 제안받을 수 있습니다.
          </p>
          <Button
            size="lg"
            asChild
